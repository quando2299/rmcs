...
type VideoStreamerProper struct {
...
func NewVideoStreamerProper(track *webrtc.TrackLocalStaticSample) *VideoStreamerProper {
	fps := uint32(30)
	return &VideoStreamerProper{
		track:            track,
...
func (v *VideoStreamerProper) LoadH264Files(directory string) error {
...
func (v *VideoStreamerProper) parseInitialNALUnits(filepath string) error {
...
func (v *VideoStreamerProper) getInitialNALUnits() []byte {
...
func (v *VideoStreamerProper) StartStreaming() {
	v.mu.Lock()
	defer v.mu.Unlock()
...
func (v *VideoStreamerProper) StopStreaming() {
	v.mu.Lock()
	defer v.mu.Unlock()
...
func (v *VideoStreamerProper) streamLoop() {
...
func (v *VideoStreamerProper) convertToAnnexB(data []byte) []byte {
